...
export interface McpPresetEnvPrompt {
    key: string
    label: string
    placeholder?: string
    secret?: boolean
...
export interface McpPreset {
    ...
    envPrompts?: McpPresetEnvPrompt[]
}

export const DEFAULT_CATALOG_PRESETS: McpPreset[] = [
    {
        id: 'github',
        name: 'GitHub',
        category: 'Development',
        description: 'Search repositories, manage issues, read PRs and inspect commits',
        config: {
            command: 'npx',
