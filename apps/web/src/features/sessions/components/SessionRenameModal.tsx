            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div>
                    <input
                        ...
                        className="w-full bg-white/[0.03] border border-[#2B2A27] rounded-lg px-3.5 py-2.5 text-white text-[13px] focus:outline-none focus:border-[#87B2F4] focus:ring-1 focus:ring-[#87B2F4]/30 selection:bg-[#87B2F4] selection:text-black transition-[border-color,box-shadow] duration-200 placeholder:text-[#4A4948]"
