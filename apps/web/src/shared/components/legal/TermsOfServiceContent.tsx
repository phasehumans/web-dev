        ...
        <div className="flex flex-col w-full max-w-[800px] text-[#D6D5C9]">
            ...
            <div className="flex flex-col gap-6 border-t border-[#242323] pt-5">
                ...
                <section className="flex flex-col gap-2">
                    <h2 className="text-[14px] font-medium text-white">1. Acceptance of Terms</h2>
                    ...
                    <p className="text-[13.5px] text-[#9A9998] leading-relaxed">
                        By registering for an account, accessing, or using December Agent, you agree
                ...
                <section className="flex flex-col gap-2">
                    ...
                    <div className="space-y-2 text-[13.5px] text-[#9A9998] leading-relaxed">
                        <p>
                            ...
                            generate using December Agent. Phase Humans Inc. claims no intellectual
                            property rights over your software or projects.
                        </p>
                        <p>
                            <strong className="text-[#D6D5C9]">Our Intellectual Property:</strong>{' '}
                            Phase Humans Inc. retains all right, title, and interest in and to the
                            December Agent platform, brand, logos, user interface, software engine,
                            and documentation.
                        </p>
                    </div>
                </section>
                ...
                <section className="flex flex-col gap-2">
                    ...
                    <p className="text-[13.5px] text-[#9A9998] leading-relaxed">
                        December Agent employs artificial intelligence models to synthesize code and
                ...
                <section className="flex flex-col gap-2">
                    <h2 className="text-[14px] font-medium text-white">6. Acceptable Use Policy</h2>
                    <p className="text-[13.5px] text-[#9A9998] leading-relaxed">
                ...
                <section className="flex flex-col gap-2">
                    ...
                    <p className="text-[13.5px] text-[#9A9998] leading-relaxed">
                        ...
                        HUMANS INC., ITS DIRECTORS, EMPLOYEES, OR AFFILIATES BE LIABLE FOR ANY
                        INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING
                        OUT OF OR IN CONNECTION WITH YOUR USE OF DECEMBER AGENT.
                    </p>
                </section>
                ...
                <section className="flex flex-col gap-2 border-t border-[#242323] pt-5">
                    <h2 className="text-[14px] font-medium text-white">11. Contact Information</h2>
                    <p className="text-[13.5px] text-[#9A9998] leading-relaxed">
